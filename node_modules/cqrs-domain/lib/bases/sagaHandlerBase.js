...
SagaHandler.prototype = {
    ...
    defaultHandle: function(id, evt, uow) {
    ...
    handle: function(evt, uow) {
        if (this[evt.event]) {
            this[evt.event](evt);
        } else {
            this.defaultHandle(evt.payload.id, evt, uow);
        }
    },
    SetUOW : function(uow)
    {
    ...
    loadSaga: function(id, callback, uow) {
        var self = this;
        var saga = this.sagas[id];
        if (!saga) {
            saga = new this.Saga(id, uow);
